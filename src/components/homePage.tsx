        ...
        <>
            <div className="header-content" id="home">
                <div className="introduction">
                    <h1>
                        Welcome The <span style={{ color: "#4F772D" }}>Better</span> <br /> Version Of Yourself
                    </h1>
                    <p style={{ marginTop: "56px" }}>
                        Lorem ipsum dolor sit amet consectetur. Tellus libero nec ornare netus tincidunt. Orci blandit
                        lectus accumsan magna dictumst tortor.
                    </p>
                ...
                <div className="offers">
                    <div className="offer">
                        <div className="offer-content">
                            ...
                            <p style={{ marginTop: "24px" }}>
                                Receive a tailored nutrition plan designed specifically for your <br /> body and goals.
                                Our certified nutritionists will consider your <br /> unique needs, dietary
                                preferences, and health conditions to <br /> create a plan that suits you best.
                            </p>
                        </div>
                    </div>
                    <div className="offer">
                        <div className="offer-content">
                            ...
                            <p style={{ marginTop: "24px" }}>
                                ...
                                and support throughout your journey. They will answer your questions, address your
                    ...
                    <div className="offer">
                        <div className="offer-content">
                            ...
                            <p style={{ marginTop: "24px" }}>
                                Effortlessly track your food intake using our user-friendly app. Our nutritionists will
                                analyze your data to provide insights into your eating habits, help you identify areas
                    ...
                    <div className="offer">
                        <div className="offer-content">
                            ...
                            <p style={{ marginTop: "24px" }}>
                                Access a vast collection of delicious and healthy recipes tailored to your dietary
                                needs. Our nutritionists will also create personalized meal plans, making it easier for
                                you to stay on track and enjoy nutritious meals.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="stats-container" id="stats">
                ...
                <div className="info">
                    <p>
                        Lorem ipsum dolor sit amet consectetur. Tellus libero nec ornare netus tincidunt. Orci
                        blandit.
                    </p>
                    <a href="#">Join us →</a>
                </div>
